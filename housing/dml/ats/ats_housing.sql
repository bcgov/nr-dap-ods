SELECT
	...
	CASE
		SUBSTR(
			...
			INSTR(projects.project_description, '', '', 1, 3) - INSTR(projects.project_description, '', '', 1, 2) -1
		)
		WHEN '' IL '' THEN '' Y ''
		WHEN '' Not_IL '' THEN '' N''
		ELSE '' Unknown ''
	...
	CASE
		SUBSTR(
			...
			INSTR(projects.project_description, '', '', 1, 4) - INSTR(projects.project_description, '', '', 1, 3) -1
		)
		WHEN '' Rental '' THEN '' Y ''
	...
	CASE
		SUBSTR(
			...
			INSTR(projects.project_description, '', '', 1, 2) - INSTR(projects.project_description, '', '', 1, 1) -1
		)
		WHEN '' SH '' THEN '' Y ''
		WHEN '' Not_SH '' THEN '' N''
		ELSE '' Unknown ''
				...
				REPLACE(
					REPLACE(
						SUBSTR(
							projects.project_description,
							1,
							INSTR(projects.project_description, '', '') -1
						),
						'' Unknown_Units '',
						NULL
					),
	...
	REPLACE(
		SUBSTR(
			...
			INSTR(projects.project_description, '', '', 1, 5) - INSTR(projects.project_description, '', '', 1, 4) -1
		),
		'' Unknown '',
		NULL
	) estimated_housing,
...
WHERE
	projects.project_id = authorizations.project_id
	AND authorizations.adjudication_date > TO_DATE(
		'' 2023 -04 -01 00 :00 :00 '',
