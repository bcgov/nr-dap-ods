...
def get_licence_issued_advertised_main_previous_ytd_query():
    ...
    FROM
        bcts_staging.licence_issued_advertised_official_previous_ytd AS official
