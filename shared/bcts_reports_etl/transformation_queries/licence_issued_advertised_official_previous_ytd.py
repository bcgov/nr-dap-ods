...
def get_licence_issued_advertised_official_previous_ytd_query(start_date, end_date):
    ...
    INSERT INTO BCTS_STAGING.licence_issued_advertised_official_previous_ytd (
