...
GRANT SELECT, DROP, ALTER ON ALL VIEWS IN SCHEMA lrm_replication TO bcts_etl_user WITH GRANT OPTION;
GRANT SELECT, DROP, ALTER ON ALL VIEWS IN SCHEMA bcts_staging TO bcts_etl_user WITH GRANT OPTION;
GRANT SELECT, DROP, ALTER ON ALL VIEWS IN SCHEMA bcts_reporting TO bcts_etl_user WITH GRANT OPTION;

GRANT SELECT, DROP, ALTER ON ALL MATERIALIZED VIEWS IN SCHEMA lrm_replication TO bcts_etl_user WITH GRANT OPTION;
GRANT SELECT, DROP, ALTER ON ALL MATERIALIZED VIEWS IN SCHEMA bcts_staging TO bcts_etl_user WITH GRANT OPTION;
GRANT SELECT, DROP, ALTER ON ALL MATERIALIZED VIEWS IN SCHEMA bcts_reporting TO bcts_etl_user WITH GRANT OPTION;
...
ALTER DEFAULT PRIVILEGES IN SCHEMA lrm_replication GRANT SELECT, DROP, ALTER ON VIEWS TO bcts_etl_user;
ALTER DEFAULT PRIVILEGES IN SCHEMA bcts_staging GRANT SELECT, DROP, ALTER ON VIEWS TO bcts_etl_user;
ALTER DEFAULT PRIVILEGES IN SCHEMA bcts_reporting GRANT SELECT, DROP, ALTER ON VIEWS TO bcts_etl_user;

ALTER DEFAULT PRIVILEGES IN SCHEMA lrm_replication GRANT SELECT, DROP, ALTER ON MATERIALIZED VIEWS TO bcts_etl_user;
ALTER DEFAULT PRIVILEGES IN SCHEMA bcts_staging GRANT SELECT, DROP, ALTER ON MATERIALIZED VIEWS TO bcts_etl_user;
ALTER DEFAULT PRIVILEGES IN SCHEMA bcts_reporting GRANT SELECT, DROP, ALTER ON MATERIALIZED VIEWS TO bcts_etl_user;
