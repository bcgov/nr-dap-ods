...
-- 1, as AMICHEL
SELECT
	administration.create_proxy_account('ats_replication', '');

SELECT
	administration.create_proxy_account('fta_replication', '');

SELECT
	administration.create_proxy_account('lexis_replication', '');

SELECT
	administration.create_proxy_account('rrs_replication', '');
...
-- 3, as ods_admin_user
GRANT USAGE,
CREATE ON SCHEMA ats_replication TO ats_replication;
...
,
DELETE
	ON ALL TABLES IN SCHEMA ods_data_management TO ats_replication;

GRANT USAGE,
CREATE ON SCHEMA rrs_replication TO rrs_replication;
...
,
DELETE
	ON ALL TABLES IN SCHEMA ods_data_management TO rrs_replication;

GRANT USAGE,
CREATE ON SCHEMA lexis_replication TO lexis_replication;
...
,
DELETE
	ON ALL TABLES IN SCHEMA ods_data_management TO lexis_replication;

GRANT USAGE,
CREATE ON SCHEMA fta_replication TO fta_replication;
...
,
DELETE
	ON ALL TABLES IN SCHEMA ods_data_management TO fta_replication;
